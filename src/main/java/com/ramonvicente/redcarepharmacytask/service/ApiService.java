...
public interface ApiService {
   ...
   * @param {@link Integer} containing the amount of {@link GithubItemResponse} to be returned.
   * @return {@link GithubRepositoryResponse} that contains the list of items.
   */
  GithubRepositoryResponse getAllPopularFromDate(String createdDate, Integer limit);
}
